public class Matrix {
    ...
    public int getValueAt(int rowPosition, int colPosition) throws IndexOutOfBoundsException {
        if (rowPosition < 0 || rowPosition >= nRow || colPosition < 0 || colPosition >= nColumn) {
            String msg = "Indeks diluar matriks.";
    ...
    public Matrix add(Matrix other) throws InvalidOperationException {
        if (this.getNRow() != other.getNRow() || this.getNColumn() != other.getNColumn()) {
            String opType = "add";
            String description = "Ukuran matriks tidak sama.";
            throw new InvalidOperationException(opType, description);
        }
    ...
    public Matrix multiply(Matrix other) throws InvalidOperationException {
        if (this.getNColumn() != other.getNRow()) {
            String opType = "multiply";
            String description = "Ukuran kolom matriks pertama tidak sama dengan ukuran baris matriks kedua.";
            throw new InvalidOperationException(opType, description);
        }
